    ...
    public partial class MainWindow : Window
    {
        ...
        private void CheckAnswer()
        {
            if (int.TryParse(AnswerInput?.Text, out int answer))
            {
                ...
                else
                {
                    ...
                    _ = MessageBox.Show(this, "Beklager, det var feil. Prøv igjen!", "Feil svar");
                    if (AnswerInput != null)
                    {
                        AnswerInput.Text = "";
                        AnswerInput.Focus();
            ...
            {
                _ = MessageBox.Show(this, "Vennligst skriv inn et gyldig tall!", "Ugyldig input");
            }
        }
        ...
        private void ShowVictory()
        {
            if (VictoryText != null)
            {
                ...
                {
                    _ = MessageBox.Show(this, "Gratulerer! Du har løst nok oppgaver og kan bruke datamaskinen i 30 minutter!", "Bra jobbet!");
                    Close();
        ...
        private void Timer_Tick(object? sender, EventArgs e)
        {
            ...
            {
                timer?.Stop();
                _ = MessageBox.Show(this, "Tiden er ute! Du må løse flere oppgaver for å fortsette å bruke datamaskinen.", "Tid er ute");
                Close();
            }
        }
    }
